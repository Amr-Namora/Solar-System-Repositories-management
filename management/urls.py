...
urlpatterns = [
    ...
    path('push/register/', views.register_push_token, name='register_push_token'),
    path('push/unregister/', views.unregister_push_token, name='unregister_push_token'),
    ...
    path('edit_amount_Amount',views.edit_amount_Amount,name='edit_amount_Amount'),
